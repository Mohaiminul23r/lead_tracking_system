...
var employeetypeDataTable = null;
window.addEventListener("load",function(){

	 /*start ajax for insert*/
    $('#addBtn').click(function(){
       utlt.Add('employeetypes', '#employeetypeDataTable');
    });
    /*End Ajax for insert*/
    ...
    $('#editBtn').click(function(){
        var id = $("#id").val();
        utlt.Edit('employeetypes', id, '#employeetypeDataTable');
    });
    /*-----------End ajax for Update------------*/
    ...
    $(document).on('click', '.edit-modal', function() {
       var id = $(this).data('id');
        $.ajax({
            url : utlt.siteUrl('employeetypes/'+id+'/edit'),
            type : "GET"
    ...
    $('#deleteBtn').click(function(){
    	var id = $("#id").val();
    	utlt.Delete('employeetypes', id, '#employeetypeDataTable');
    });
	/*-----------End ajax for Delete------------*/


    /*Start data table*/
	employeetypeDataTable = $('#employeetypeDataTable').DataTable({
		...
		columns : [
		{
			...
			'render' : function(data, type, row, ind){
				var pageInfo = employeetypeDataTable.page.info();
		...
		processing : true,
		ajax: {
			url: utlt.siteUrl()+'employeetype/get-data-json',
			dataSrc: 'data'
		},
	});
