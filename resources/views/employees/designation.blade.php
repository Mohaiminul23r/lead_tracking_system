    ...
    <div class="modal-body">
        <form id="addForm" class="form-horizontal" role="form">
            ...
            <div class="form-group">
                <label class="control-label col-sm-3" for="name">Designation Name:</label>
                <div class="col-sm-9">
                    <input type="name" class="form-control" name="name" id="name" placeholder="enter the designation name">
                    <span class="help-block"></span>
                </div>
            </div>
        </form>
...
@section('main-content')
    {{-- Start data table --}}
    <table id="designationDataTable" class="table table-striped table-bordered" style="width:100%">
    </table>

    {{-- End data table --}}
    <script src="{{asset('assets')}}/scripts/designation.js"></script>
