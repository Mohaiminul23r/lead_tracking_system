...
<body>
    ...
    <div class="content-header">
        ...
        <h5 style="text-align:center;margin-bottom:20px;">Sales report from {{\Carbon\Carbon::parse($from_date)->format('d M Y')}} to {{\Carbon\Carbon::parse($to_date)->format('d M Y')}}</h5>
        </div>
        <!-- Main content -->
        <div class="content">
            <div class="row">
